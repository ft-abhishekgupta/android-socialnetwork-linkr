...
public class TabRequestSent extends Fragment {
    ...
    public void onResume() {
        ...
        adapterPendingRequests=new AdapterPendingRequests(mMainView.getContext(),fetch(),"sent");
    ...
    private ArrayList<ModelFriendRequest> fetch() {
        ...
        db_friendList.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    if(dataSnapshot.child(ds.getKey()).child("user_status").getValue().toString().equals("requestSent"))
                    {
