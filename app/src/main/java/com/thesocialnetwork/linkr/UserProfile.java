    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db_usersProfile.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Glide.with(UserProfile.this).load(user_img).thumbnail(0.5f).crossFade().centerCrop()
                        .diskCacheStrategy(DiskCacheStrategy.ALL).into(user_img_view);
            }
                ...
                db_detailedInfo.child("other_phone").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            if (dataSnapshot.child(ds.getKey()).child("privacy").getValue().toString()
                                    .equals("Everyone")) {
