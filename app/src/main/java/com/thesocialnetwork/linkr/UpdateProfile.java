...
//        this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        if (firebaseUser != null) {
            ...
            if (!userImg.equals("")) {
                Glide.with(getApplicationContext()).load(userImg.toString())
                        .thumbnail(0.5f)
            ...
            sRef.putFile(file)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if(downloadedUri!=null) isImgChanged=true;
                        }
                    })
    ...
    private void storeData(boolean isImgChanged) {
        ...
        if(isImgChanged)
        {
            ModelUserProfile modelUserProfile = new ModelUserProfile(UserId,name,phone,email,downloadedUri.toString(),"");
